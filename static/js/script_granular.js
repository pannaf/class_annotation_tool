...
function refresh_videos(data,num_videos,video_index) {
  ...
  for (var i = video_index; i < num_videos+video_index; i++) {
    ...
    video_tag = "<li><video controls id='myVideo" + i + "' height='300' style='padding:0px;border-width:10px 10px 10px 10px; border-style:solid;border-color:" + video_border_color + ";'" + on_click + "><source src='" + src + "' type='video/mp4'></video></li>";
